...
export default function App() {
  ...
  useEffect(() => {
    audioRef.current = new Audio('/marindalcrew_a-thousand-years-cristina-perri-mp3 (2).mp3');
  ...
  return (
    <div className="font-sans text-stone-800 bg-brand-ivory selection:bg-brand-beige-deep/20 min-h-full">
      ...
      <div className="pt-24 pb-8 sm:py-32 bg-white relative">
        <CeremonyDetails />
      </div>

      <div className="pt-8 pb-24 sm:py-32 bg-gradient-to-b from-white via-brand-champagne/30 to-brand-ivory relative">
        <Location />
      </div>
      ...
      <footer className="py-12 bg-white border-t border-brand-beige/20 text-center relative overflow-hidden mt-10">
        ...
        <p className="font-display text-4xl sm:text-5xl text-stone-800 mb-2">Prarthana &&nbsp;Akilanka</p>
