      ...
      <style>{`
        ...
        * {
        ...
        .scene {
          ...
          padding: 20px;
          background: radial-gradient(ellipse at 30% 20%, #FFFFFF 0%, #FAF9F6 40%, #EAE3D2 100%);
          perspective: 1500px;
          overflow: hidden;
        ...
        .envelope-base {
          position: absolute;
          inset: 0;
          background: linear-gradient(145deg, #FDFBF7, #EAE3D2);
          border-radius: 6px;
          box-shadow: 0 30px 60px -15px rgba(166,124,0,0.2), 0 0 0 1px rgba(197,160,89,0.3);
          z-index: 1;
        }
        ...
        .flap-left {
          ...
          width: 66%;
          height: 100%;
          background: linear-gradient(135deg, #FFFFFF 0%, #FAF9F6 50%, #EAE3D2 100%);
          background-image: url("https://www.transparenttextures.com/patterns/cream-paper.png");
          border-right: 1px solid rgba(201,169,110,0.3);
          box-shadow: 10px 0 30px -10px rgba(166,124,0,0.2);
          ...
          <div className="card-container">
            <div className="card-border">
              ...
              <div className="text-details">
                ...
                <span className="text-date">Thursday 27 August 2026 At 09:30 AM</span>
                <span className="text-church">Asliya Regency Hotel</span><br />
                Kandy Road, Pilessa
              </div>
            </div>
          </div>
