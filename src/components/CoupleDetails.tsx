  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
      ...
      <div className="text-center mb-16 sm:mb-24 relative z-10">
        ...
        >
          ...
          <h2 className="text-5xl sm:text-7xl font-display text-stone-800 tracking-tight drop-shadow-sm">
            Prarthana <span className="italic text-brand-beige-deep font-light mx-2">&</span>&nbsp;Akilanka
          </h2>
        </motion.div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-8 relative z-10">
        ...
        <motion.div
          {...inViewProps({ opacity: 0, x: -30 }, { opacity: 1, x: 0 })}
        ...
        >
          <div className="mb-4 flex flex-col items-center lg:items-end">
            ...
            <h3 className="text-4xl sm:text-5xl font-display text-stone-800 mb-2 drop-shadow-sm">Akilanka</h3>
            <p className="text-stone-500/90 font-serif italic text-base sm:text-lg">Son of Mr Athula Rathna</p>
          </div>
        ...
        <motion.div
          {...inViewProps({ opacity: 0, scale: 0.95, y: 20 }, { opacity: 1, scale: 1, y: 0 })}
        ...
        >
          <div className="mb-4 flex flex-col items-center lg:items-start">
            ...
            <h3 className="text-4xl sm:text-5xl font-display text-stone-800 mb-2 drop-shadow-sm">Prarthana</h3>
            <p className="text-stone-500/90 font-serif italic text-base sm:text-lg">Daughter of Mr Gamini Disanayaka</p>
          </div>
