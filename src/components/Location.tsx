...
export const Location: React.FC = () => {
  const venueAddress = "Asliya Regency Hotel, Kandy Road, Pilessa";
  const mapUrl = `https://maps.google.com/maps?q=Asliya+Regency+Hotel+Pilessa&t=&z=14&ie=UTF8&iwloc=&output=embed`;
  const liveLocationUrl = "https://maps.google.com/?q=Asliya+Regency+Hotel+Pilessa";
  ...
  return (
    <div className="max-w-[85rem] mx-auto px-6 relative py-12">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-0 mt-10">
        ...
        <motion.div 
          {...inViewProps({ opacity: 0, x: -40 }, { opacity: 1, x: 0 })}
          ...
          <div className="bg-white/90 backdrop-blur-2xl p-10 sm:p-14 lg:p-16 rounded-[2.5rem] shadow-[0_30px_60px_rgba(176,137,104,0.15)] border border-brand-beige/30 lg:translate-x-12 relative overflow-hidden group">
            ...
            <div className="mb-10 relative z-10">
              ...
              <div className="flex items-start gap-5 mt-10">
                ...
                <div>
                  <p className="text-2xl font-serif text-stone-800 mb-1">Asliya Regency Hotel</p>
                  <p className="text-[11px] uppercase tracking-[0.2em] font-medium text-stone-400 leading-relaxed mb-6">Kandy Road, Pilessa</p>
        ...
        <motion.div 
          {...inViewProps({ opacity: 0, scale: 0.95 }, { opacity: 1, scale: 1 })}
        ...
        >
          ...
          <div className="w-full h-full rounded-[2.5rem] lg:rounded-[3rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)] border-[8px] sm:border-[12px] border-white relative group/map">
            ...
            <iframe
              title="Asliya Regency Hotel Location"
              src={mapUrl}
              width="100%"
              height="100%"
